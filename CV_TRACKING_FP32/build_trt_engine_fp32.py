...
# Paths
# Paths
ONNX_FILE = "/mnt/f/desktop/CV_Project/CV_TRACKING_FP32/ostrack.onnx"
ENGINE_FILE = "/mnt/f/desktop/CV_Project/CV_TRACKING_FP32/ostrack.engine"
...
# Enable FP16 - DISABLED FOR FP32 BUILD
# if builder.platform_has_fast_fp16:
#     config.set_flag(trt.BuilderFlag.FP16)
#     print("✓ FP16 mode enabled")
# else:
#     print("⚠ FP16 not supported on this platform")
print("✓ FP32 mode enabled (Default)")
