...
def main():
    ...
    if args.checkpoint is None:
        ...
        # We need to go up from prj_dir (OSTrack-main) to CV_TRACKING_ADVANCED
        # prj_dir is .../CV_TRACKING_ADVANCED/OSTrack-main/OSTrack-main
        # So we go up 2 levels? No, prj_dir is where lib is.
        # Let's try absolute path based on what we know.
    ...
    torch.onnx.export(
        ...
        args.output,
        verbose=False,
        opset_version=14, # 15 might be too new for some TRT versions, 11-14 is safe
        input_names=["z", "x"],
